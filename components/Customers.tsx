          ...
          <table className="w-full text-left">
            ...
            <tfoot className="border-t-4 border-black bg-gray-50 font-black print-total-row" style={{ pageBreakInside: 'avoid' }}>
                <tr style={{ pageBreakInside: 'avoid' }}>
                    ...
                    <td className="px-6 py-4 text-right">
                        <span className="text-[10px] font-black uppercase text-gray-500 tracking-[0.1em]">
                          {lang === 'bn' ? 'মোট পাওনা (বাকি):' : 'Total Due:'}
                        </span>
                        <div className="text-xl font-black text-rose-600">৳{stats.totalDue.toLocaleString()}</div>
                    </td>
                ...
                <tr style={{ pageBreakInside: 'avoid' }}>
                    ...
                    <td className="px-6 py-2 text-right">
                        ...
                        <div className="text-xl font-black text-emerald-700">৳{stats.totalAdvance.toLocaleString()}</div>
                    </td>
                    <td className="no-print"></td>
                </tr>
